        ...
        {products.map((current, index) => (
          <tr key={ index }>
            ...
            <td
              ...
              data-testid={ `${DATA_TEST_ID[42]}${index}` }
            >
              {current.name}
            </td>
            <td
              data-label="Quantidade"
              data-testid={ `${DATA_TEST_ID[43]}${index}` }
            >
              {current.quantity}
            </td>
            <td
              data-label="Valor Unitário"
              data-testid={ `${DATA_TEST_ID[44]}${index}` }
            >
              {current.price.toLocaleString('pt-br', { minimumFractionDigits: 2 })}
            </td>
            <td
              data-label="Sub-total"
              data-testid={ `${DATA_TEST_ID[45]}${index}` }
            >
